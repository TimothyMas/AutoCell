...
void Grid::nextGeneration()
{
    ...
    // Emit the signal to notify that the grid has been updated
    emit gridUpdated();
}
...
void Grid::placeStructure(const std::vector<std::vector<bool>>& structure, int x, int y)

{
    // Iterate through the structure template and place it on the grid
...

    {
...

        {
            ...
            {
                cells[gridY][gridX] = structure[i][j];
            }
        }
    }
